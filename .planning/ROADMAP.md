...
Plans:
- [x] 04-01-PLAN.md — Remove SSH branches from resource pool CRUD and verify tests
...
Plans:
- [x] 05-01-PLAN.md — Remove SSH branches from virtual disk CRUD, implement govmomi delete, and complete data source browser
